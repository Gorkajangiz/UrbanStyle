...
public class ClientDao implements DaoInterfazClient {
    ...
    @Override
    public void updatePurchase(Long idClient) {
    ...
    @Override
    public void updateDiscount(Long idClient, Integer discount) {
        Client c = em.find(Client.class, idClient);
        if (c != null) {
    ...
    @Override
    public int getPurchases(Long idClient) {
        Client c = em.find(Client.class, idClient);
        return c != null ? c.getPurchases() : 0;
    }
}
